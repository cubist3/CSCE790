# -*- coding: utf-8 -*-
"""Reservoir Computing Network.ipynb
...
plt.xlabel('Time')
plt.ylabel('Value')
plt.savefig('/content/drive/My Drive/Colab Notebooks/training_data_lorenz.eps', format='eps')
plt.show()
...
plt.xlabel('Time')
plt.ylabel('Value')
plt.savefig('/content/drive/My Drive/Colab Notebooks/test_data_lorenz.eps', format='eps')
plt.show()
...
plt.xlabel('Time')
plt.ylabel('Value')
plt.savefig('/content/drive/My Drive/Colab Notebooks/training_data_rossler.eps', format='eps')
plt.show()
...
plt.xlabel('Time')
plt.ylabel('Value')
plt.savefig('/content/drive/My Drive/Colab Notebooks/test_data_rossler.eps', format='eps')
plt.show()
